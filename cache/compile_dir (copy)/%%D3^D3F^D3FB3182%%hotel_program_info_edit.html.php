<?php /* Smarty version 2.6.19, created on 2016-08-23 10:31:53
         compiled from hotel/hotel_program_info_edit.html */ ?>
...
<div class="main">
	...
	<div class="table-box">
		...
		<div class="table-data-box">
			<form id="form1" method="post" enctype="multipart/form-data" action="hotel_program_info_edit_post.php">
...
" name="program_num_old" id="program_num_old" hidden="true" /></td>
					...
					<tr>
						<td><input type=text value="<?php echo $this->_tpl_vars['g_show']['item']['playing_state']; ?>
" name="playing_state" id="playing_state" hidden="true" /></td>
					</tr>
            </table>
			</form>
		</div>
