<?php /* Smarty version 2.6.19, created on 2016-01-04 17:07:40
         compiled from hotel/hotel_cookbook_category_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_cookbook_category_edit.php" class="button">添加分类</a>
					</td>
					<td align="right">
						<form class="search-form">
							菜单分类：
							<input type="text" class="key" name="cookbook_category_name" />
...
?>
				<tr >
					...
					<td>
						<a href="hotel_cookbook_category_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('hotel_cookbook_category_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
