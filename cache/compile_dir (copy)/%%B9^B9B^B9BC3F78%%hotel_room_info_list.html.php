<?php /* Smarty version 2.6.19, created on 2016-08-23 10:01:58
         compiled from hotel/hotel_room_info_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_room_info_edit_add.php" class="button">添加</a>
					</td>
				</tr>
			</table>
		</div>
...
?>
				<tr>
					...
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['room_num']; ?>

					</td>
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['room_mac']; ?>

					</td>
					<td>
						<a href="hotel_room_info_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('hotel_room_info_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
