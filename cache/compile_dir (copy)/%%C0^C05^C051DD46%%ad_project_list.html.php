<?php /* Smarty version 2.6.19, created on 2014-07-02 16:46:12
         compiled from ad/ad_project_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="ad_project_edit.php" class="button">添加区域</a>
					</td>
					<td align="right">
						<form class="search-form">
							项目名称：
							<input type="text" class="key" name="ad_project_name" />
...
?>
				<tr>
					...
					<td>
						<a href="ad_project_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
