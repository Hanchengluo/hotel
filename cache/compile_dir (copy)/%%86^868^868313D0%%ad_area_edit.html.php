<?php /* Smarty version 2.6.19, created on 2015-12-14 15:21:50
         compiled from ad/ad_area_edit.html */ ?>
...
<div class="main">
	...
	<div class="table-box">
		<div class="table-top">
			<a href="ad_area_list.php" class="button button_a">返回广告位</a>
		</div>
		<div class="table-data-box">
			<form id="form1" method="post" enctype="multipart/form-data" action="ad_area_edit_post.php">
