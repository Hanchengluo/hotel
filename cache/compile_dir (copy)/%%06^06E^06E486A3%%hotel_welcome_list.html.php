<?php /* Smarty version 2.6.19, created on 2016-11-14 16:52:22
         compiled from hotel/hotel_welcome_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_welcome_edit.php" class="button">添加</a>
					</td>
				</tr>
			</table>
		</div>
...
" width=87 height=87>
					...
					<td width=300 style="word-break:break-all">
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['welcome_info']; ?>

					</td>
					<td>
						<a href="hotel_welcome_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	if (r == true) {
		...
		$.post('hotel_welcome_edit_post.php?type=del&id='+id, '', function(data){
			if (data.error == 1)
			{
				alert(data.errmsg);
			}
