<?php /* Smarty version 2.6.19, created on 2015-12-28 14:37:47
         compiled from hotel/hotel_video_category_edit.html */ ?>
...
<div class="main">
	...
	<div class="table-box">
		<div class="table-top">
			<a href="hotel_video_category_list.php" class="button button_a">返回分类</a>
		</div>
		<div class="table-data-box">
			<form id="form1" method="post" enctype="multipart/form-data" action="hotel_video_category_edit_post.php">
...
" name="id" id="id" />
				...
				<table class="table-add-modify">
					<tr>
						...
						<td><input type=text value="<?php echo $this->_tpl_vars['g_show']['item']['video_category_name']; ?>
" name="video_category_name" id="video_category_name" /></td>
					</tr>
