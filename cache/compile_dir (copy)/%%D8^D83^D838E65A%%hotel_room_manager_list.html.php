<?php /* Smarty version 2.6.19, created on 2016-03-29 13:41:33
         compiled from hotel/hotel_room_manager_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_room_manager_edit.php" class="button">上传文件</a>
					</td>
				</tr>
			</table>
		</div>
...
?>
				<tr>
					...
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['room_file_address']; ?>

					</td>
					<td>
						<a href="hotel_room_manager_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('hotel_room_manager_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
