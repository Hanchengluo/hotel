<?php /* Smarty version 2.6.19, created on 2015-12-18 16:47:37
         compiled from hotel/hotel_program_edit.html */ ?>
...
<div class="main">
    ...
    <div class="table-box">
    	<div class="table-top">
				<a href="hotel_program_list.php" class="button button_a">返回节目列表</a>
      </div>
    	<div class="table-data-box">
				<form id="my_form" method="post" enctype="multipart/form-data" action="hotel_program_edit_post.php">
