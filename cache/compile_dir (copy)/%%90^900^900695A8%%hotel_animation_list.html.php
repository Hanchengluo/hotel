<?php /* Smarty version 2.6.19, created on 2016-08-23 10:01:59
         compiled from hotel/hotel_animation_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_animation_edit.php" class="button">添加动画</a>
					</td>
				</tr>
			</table>
		</div>
...
?>
				<tr>
					...
					<!-- <td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['url']; ?>

					</td> -->
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['version']; ?>

					</td>
					<td>
						<a href="hotel_animation_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('hotel_animation_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
