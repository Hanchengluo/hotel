<?php /* Smarty version 2.6.19, created on 2016-11-14 16:52:28
         compiled from hotel/hotel_video_category_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_video_category_edit.php" class="button">添加分类</a>
					</td>
					<td align="right">
						<form class="search-form">
							视频分类：
							<input type="text" class="key" name="video_category_name" />
...
?>
				<tr >
					...
					<td>
						<a href="hotel_video_category_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	if (r == true) {
		...
		$.post('hotel_video_category_edit_post.php?type=del&id='+id, '', function(data){
			if (data.error == 1)
			{
				alert(data.errmsg);
			}
