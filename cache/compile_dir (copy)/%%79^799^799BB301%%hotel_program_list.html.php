<?php /* Smarty version 2.6.19, created on 2015-12-18 17:15:00
         compiled from hotel/hotel_program_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="hotel_program_edit.php" class="button">上传文件</a>
					</td>
				</tr>
			</table>
		</div>
...
?>
				<tr>
					...
					<td>
						<a href="hotel_program_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('hotel_program_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
