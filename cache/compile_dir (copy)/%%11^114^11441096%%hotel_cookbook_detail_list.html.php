<?php /* Smarty version 2.6.19, created on 2016-11-14 16:52:30
         compiled from hotel/hotel_cookbook_detail_list.html */ ?>
...
$this->_sections['count']['loop'] = is_array($_loop=$this->_tpl_vars['g_show']['cookbook_category_list']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
							<option value="<?php echo $this->_tpl_vars['g_show']['cookbook_category_list'][$this->_sections['count']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['g_show']['cookbook_category_list'][$this->_sections['count']['index']]['cookbook_category_name']; ?>
</option>
							<?php endfor; endif; ?>
							</select>
							&nbsp; &nbsp;
...
?>
				<tr>
					...
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['cookbook_category_name']; ?>

					</td>
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['cookbook_name']; ?>

					</td>
					<td>
					<img src="<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['cookbook_thumbnail_address']; ?>
" width=87 height=87>
					</td>
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['cookbook_introduction']; ?>

					</td>
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['cookbook_price']; ?>

					</td>
					<td>
						<a href="hotel_cookbook_detail_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
