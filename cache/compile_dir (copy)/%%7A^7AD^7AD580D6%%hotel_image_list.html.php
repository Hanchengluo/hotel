<?php /* Smarty version 2.6.19, created on 2015-12-11 17:53:45
         compiled from hotel/hotel_image_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="ad_image_edit.php" class="button">添加图片</a>
					</td>
					<td align="right">
						<form class="search-form">
							广告商：
							<select method="get" name="ad_advertiser_id" action="?">
...
?>
				<tr>
					...
					<td>
					<img src="<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['address']; ?>
" width=87 height=87>
					</td>
					<!-- 
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['address']; ?>

					</td>
					 -->
					<td>
						<a href="ad_image_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('ad_image_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
