<?php /* Smarty version 2.6.19, created on 2014-07-03 09:48:57
         compiled from ad/ad_category_type_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="ad_category_type_edit.php" class="button button_a">添加绑定对象</a>
					</td>
					<td align="right">
						<form class="search-form">
							绑定对象名称：
							<input type="text" class="key" name="ad_category_type_name" />
...
?>
				<tr>
					...
					<td>
						<a href="ad_category_type_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('ad_category_type_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
