<?php /* Smarty version 2.6.19, created on 2014-07-03 09:48:57
         compiled from ad/ad_category_list.html */ ?>
	...
	<div class="table-box">
		<div class="table-top">
			<table width="100%">
				<tr>
					<td align="left">
						<a href="ad_category_edit.php" class="button button_a">添加对象内容</a>
					</td>
					<td align="right">
						<form class="search-form">
							类别：
							<select method="get" name="ad_category_type" action="?">
...
"><?php echo $this->_tpl_vars['g_show']['ad_category_type_list'][$this->_sections['count']['index']]['name']; ?>
							...
							&nbsp; &nbsp;类别值搜索：
							<input type="text" class="key" name="ad_category_value" />
...
?>
				<tr >
					...
					<td>
						<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['value']; ?>

					</td>
				
					<td>
						<a href="ad_category_edit.php?id=<?php echo $this->_tpl_vars['g_show']['list'][$this->_sections['count']['index']]['id']; ?>
">编辑</a>
...
function del_one(id)
{
	...
	$.post('ad_category_edit_post.php?type=del&id='+id, '', function(data){
		if (data.error == 1)
		{
			alert(data.errmsg);
		}
